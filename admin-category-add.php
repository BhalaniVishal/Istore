...
<body>
    ...
    <div class="formarea"> 
        <center><h1 style="color:#5A88CA">CATEGORY ADD</h1></center>
        <form action="admin-category-add.php" method="post">


            <div class="container">
                <label for="catname"><b>ENTER CATEGORY NAME :- </b></label>
                <input type="text" placeholder="Enter name of category" name="categoryName" required><br>
