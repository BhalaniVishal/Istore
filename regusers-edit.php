...
<body>
    ...
    <?php
                ...
                $query = "Select * from registeredusers where userId='$_REQUEST[id]'";
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="moblieNo">CONTACT NO:</label>
                <input type="text" class="form-control" value="<?php echo $row["moblieNo"]; ?>" name="moblieNo" id="moblieNo">
            </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $birthDate= $_POST['birthDate'];
            ...
            $cmd = "update  registeredusers set  userName='$userName', moblieNo='$moblieNo',gender='$gender', email='$email',city='$city',address='$address',password='$password',birthDate='$birthDate' where userId='$_REQUEST[id]'";
