...
<body>
  ...
  <div class="container">
   ...
   <center style=" color:#5a88ca; " >    <?php  echo "<h1 >Wel-come  ".$_SESSION["admin"]["name"]."</h1>";  ?></center>


   <div class="container">
    <h1  class="text-danger"> LATEST ORDERS </h1>
    <table class="table">
        ...
        <?php
            $query="Select o.*,u.userName,u.mobileNo,p.productName from orders o,registeredusers u,products p 
                    where o.productid=p.productid and o.userid=u.userid order by orderId desc limit 5";
