...
<body>
   ...
   <div class="container">
   <h1 style="color:#5A88CA">REVIEW CONTROLS</h1>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                            <a  href="review-edit.php?id=<?php echo $row['reviewId'] ?>"><button type="button" class="btn btn-primary ">EDIT</button></a>
                            <a onclick='return confirm(" DO YOU WANT TO DELETE THIS RECORD PERMENENTLY???")' href="admin-review-controls.php?reviewId=<?php echo $row['reviewId'] ?>"> <button type="button" class="btn btn-danger ">DELETE</button></a>
                        </td>
